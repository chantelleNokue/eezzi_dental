...
function signUp() {
  ...
  <form class="bg-white-500 shadow-md rounded px-8 pt-6 pb-8 mb-4">
    <div class="mb-4">
      ...
      <input class="shadow appearance-none border-2 border-sky-500 rounded w-full py-2 px-3 text-gray-500 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Fullname"/>
    </div>
    <div class="mb-4">
      <label class="block text-gray-700 text-sm font-bold mb-2" for="email">
        Email
      </label>
      <input class="shadow appearance-none border-2 border-sky-500 rounded w-full py-2 px-3 text-gray-500 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Email"/>
    </div>
    <div class="mb-6">
    ...
    <div class="flex items-center justify-between">
      <button class="border-2 border-sky-500 hover:bg-sky-500 text-gray-300 font-bold py-2 px-4 mr-4 rounded focus:outline-none focus:shadow-outline flex justify-center" >
        Sign Up
      </button>
